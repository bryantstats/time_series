...
- We see that the estimated slope is `r b1_hat`, which is very close to its true value. 
...
- Just like MA, we have a concept of double ES

- And we can use ES to estimate a linear trend time series
